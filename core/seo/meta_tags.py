...
class SEOManager:
    ...
    PAGE_META = {
        ...
        'donate': {
            'title': 'Поддержать проект - Добрые истории',
            'description': 'Поддержите православный портал "Добрые истории". Ваша помощь помогает создавать качественный духовный контент для всей семьи. ЮMoney, банковские карты.',
            'keywords': 'поддержка проекта, пожертвования, православный портал, юмани, помощь проекту, донаты',
            'og_title': 'Поддержите проект "Добрые истории"',
            'og_description': 'Ваша поддержка помогает создавать качественный духовный контент для всей семьи',
        },
    }
