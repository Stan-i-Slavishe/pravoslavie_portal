...
echo
echo "💾 Создаем коммит:"
git commit -m "feat: добавлены поля адреса и режима работы в SiteSettings

- Добавлены поля work_hours, work_hours_note, address_city, address_country, address_full в модель SiteSettings
- Обновлена админка с новыми секциями 'Время работы' и 'Адрес и местоположение'  
- Обновлен шаблон contact.html для использования данных из БД вместо хардкода
- Создана миграция 0003_add_address_work_hours_fields
- Добавлены скрипты для применения изменений"
