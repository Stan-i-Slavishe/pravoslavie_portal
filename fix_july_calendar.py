...
# =========================================================================
# ДОБАВЛЯЕМ КЛЮЧЕВЫЕ СОБЫТИЯ ИЮЛЯ
# =========================================================================
...
july_events = [
    ...
    {
        'day': 2,
        'title': 'Положение честной ризы Пресвятой Богородицы во Влахерне',
        'description': 'Праздник в честь положения ризы Божией Матери в храме во Влахерне.',
        'event_type': 'major_feast',
        'fasting_type': 'light_fast',  # Если в постный день
        'fasting_desc': 'Обычный день (проверить календарь постов)',
        'spiritual_note': '👗 Положение честной ризы Пресвятой Богородицы. Праздник в память о святыне, покрывающей нас молитвами Божией Матери.'
    },
    {
        'day': 8,
...
for event_data in july_events:
    ...
    # Добавляем/обновляем ежедневную информацию
    try:
