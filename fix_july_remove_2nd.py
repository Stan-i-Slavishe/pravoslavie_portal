...
# =========================================================================
# УДАЛЯЕМ 2 ИЮЛЯ (ОБЫЧНЫЙ ПОСТНЫЙ ДЕНЬ) И ДОБАВЛЯЕМ ОСТАЛЬНЫЕ СОБЫТИЯ
# =========================================================================

# Сначала удаляем 2 июля, если оно было добавлено по ошибке
print("🗑️ Удаляем лишнее событие 2 июля (обычный постный день)...")
july_2_events = OrthodoxEvent.objects.filter(month=7, day=2)
if july_2_events.exists():
    for event in july_2_events:
        print(f"   🗑️ Удаляем: {event.title}")
...
try:
    ...
    print(f"   🗑️ Удаляем ежедневную информацию для 2 июля")
    daily_info_2.delete()
...
# =========================================================================
# ДОБАВЛЯЕМ ОСТАЛЬНЫЕ СОБЫТИЯ ИЮЛЯ (БЕЗ 2 ИЮЛЯ)
# =========================================================================
...
for event_data in july_events:
    ...
    # Добавляем ежедневную информацию только для великих и больших праздников
...
print("\n" + "=" * 60)
print(f"🎉 ЗАВЕРШЕНО!")
print(f"🗑️ Удалено: 2 июля (обычный постный день)")
...
print("ℹ️  2 июля теперь обычный постный день (среда) без особых событий.")
